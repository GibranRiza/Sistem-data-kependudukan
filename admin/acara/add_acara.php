	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="detail" name="detail acara" placeholder="Detail acara" required>
				</div>
			</div>
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        $sql_simpan = "INSERT INTO tb_acara (id_acara, detail, tanggal) VALUES (
            '".$_POST['id_acara']."',
            '".$_POST['detail']."',
            '".$_POST['tanggal']."')";
