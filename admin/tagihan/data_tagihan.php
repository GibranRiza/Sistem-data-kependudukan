<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Orang Ngutang</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
            ...
            ?>
					...
					<tr>
						...
						<td>
							...
							<a href="?page=del-tagihan&kode=<?php echo $data['id_iuran']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
							 title="Lunas" class="btn btn-danger btn-sm">
